...
function Report() {
    ...
    async function loadReport() {
        try {
            ...
            console.log(error);
            alert(error.response?.data?.detail || "Unable to load report.");
        } finally {
            setLoading(false);
        }
    }
    ...
    if (loading) return <h2 style={{ textAlign: "center", marginTop: "100px" }}>Loading Report...</h2>;
    if (!report) return <h2 style={{ textAlign: "center", marginTop: "100px" }}>Report Not Found</h2>;
